  ...
  return (
    <>
      <div className="relative md:flex md:gap-[4.93rem] md:items-center md:justify-center lg:justify-start lg:pl-[10.25rem]">
        ...
        >
          <ul className=" absolute z-40 pt-[2.44rem] pb-[2.62rem] pl-[3rem]  w-full  flex flex-col justify-center items-start font-spartan text-[2rem] font-bold leading-[2.5rem] bg-very-light-grey md:bg-white md:flex-row md:text-[1.125rem] md:text-link-color md:gap-[3.81rem]">
